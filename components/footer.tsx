              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <Link
                    key={href}
                    href={href}
                    className="w-9 h-9 rounded-full border border-slate-300 hover:border-[#00A759] hover:text-[#00A759] text-slate-600 flex items-center justify-center transition"
                  >
                    {icon}
                  </Link>
                ))}
            ...
            <div className="space-y-3">
              ...
              <div className="flex gap-2 max-w-sm">
                <input
                  ...
                  className="flex-1 bg-slate-50 border border-slate-200 text-slate-800 rounded-lg px-3 py-2.5 text-xs outline-none focus:ring-2 focus:ring-[#00A759] placeholder:text-slate-400 transition"
                />
          ...
          <div className="min-w-[350px] space-y-3">
            ...
            <ul className="space-y-2.5">
              <li className="flex items-start gap-2 text-xs text-slate-600">
                ...
                <a href="mailto:sarvamcart@gmail.com" className="hover:text-[#00A759] transition">
                  sarvamcart@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-2 text-xs text-slate-600">
                <Phone className="w-3.5 h-3.5 mt-0.5 shrink-0 text-[#00A759]" />
                <a href="tel:+919408558818" className="hover:text-[#00A759] transition">
                  +91 9408558818
                </a>
              </li>
              <li className="flex items-start gap-2 text-xs text-slate-600">
